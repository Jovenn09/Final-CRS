...
const AddAccident = () => {
  ...
  const descriptionOptions = ["fire at the house" ,"solo car crashes at the tree","speeding","hit and run","head-on collision two vehicles","hit each other in opposite directions","drowning incedent ","food poisoning","chocking and suffocation","Stairway falls","Heart Attack","others"]; 
