...
const AddCrime = () => {
  ...
  const crimeOptions = ["shoplifting on local store", "arm robbery at the street","rape at the abandon house" ,"pickpocketing at the local store","hit and run at the street","stealing inside a house","drug trafficking at the house ","mugging at the street ","hit in run at the road","others"
];
